...
describe("IoTeXNetwork ERC20 Standard Test", function () {
  ...
  beforeEach(async function () {
    ...
    const Token = await ethers.getContractFactory("IoTeXNetwork");
